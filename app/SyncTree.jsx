...
class TreeChild extends React.Component{
    ...
    render(){
        ...
        //
        // const getName = param => {
        //     if (this.props.filterType == 'radio') return `${this.props.filterType}_${this.props.index}`
        //     return `${this.props.filterType}_${param}`
        // }
        // const loop = data => data.map((item,index) => {
        // if (item.child) {
        //     return <TreeNode name={item.name} key={index}>{loop(item.child)}</TreeNode>;
        // }
